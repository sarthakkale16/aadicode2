...
API_ID = int(environ['18032586'])
API_HASH = environ['4407d04c3f4f0fe56e6d03a41f64d71c'] 
BOT_TOKEN = environ['5845538167:AAE8HAUeToV2LfT3ZNWhUSFhtpenF9nz5E4']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1232136108 5504808596', '').split()]
...
auth_grp = environ.get('-1001591548398')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'rb1bots')
